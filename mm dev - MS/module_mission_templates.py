       ...
       (else_try), #Don't continue if we did no damage
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (agent_get_player_id,":attacker_player", ":attacker"),
            (agent_get_player_id,":receiver_player", ":receiver"),
            (lua_push_int, ":attacker_player"),
            (lua_push_int, ":receiver_player"),
            (lua_push_int, ":damage"),
          ...
          (else_try),
            ...
            (agent_get_player_id,":attacker_player", ":attacker"),
            (agent_get_player_id,":rider_player", ":rider"),
            (lua_push_int, ":attacker_player"),
            (lua_push_int, ":rider_player"),
            (lua_push_int, ":damage"),
    ...
    [
      ...
      (ti_on_multiplayer_mission_end, 0, 0, [],
       [
         (try_begin),
          (multiplayer_is_server),
          (lua_call, "@onDuelModeEndOrMapChange", 0),
         (try_end),
         (neg|multiplayer_is_dedicated_server),
         (assign, "$g_multiplayer_stats_chart_opened_manually", 0),
         (start_presentation, "prsnt_multiplayer_stats_chart_deathmatch"),
       ...
       [
         ...
         (try_begin),
            ...
            (try_begin),
              ...
              (player_is_active, ":duelist_player_no"),
              (lua_push_int, ":duelist_player_no"),
              (lua_push_int, ":dead_player_no"),
              (lua_call, "@onDuelBetweenPlayersEnd", 2),
            (else_try),
              (lua_push_int, ":dead_player_no"),
              (lua_push_int, ":dead_player_no"),
              (lua_call, "@onDuelBetweenPlayersEnd", 2),
       ...
       [
         (try_for_players, ":player_no", "$g_ignore_server"),
           ...
           (player_spawn_new_agent, ":player_no", reg0),
            ...
            (try_begin),
              (lua_push_int, ":player_no"),
              (lua_call, "@onPlayerRevivedDuel", 1),
              (assign, ":opponent_player_no", reg37),
              (try_begin),
                (player_is_active, ":opponent_player_no"),
                (player_get_agent_id, ":opponent_agent_id", ":opponent_player_no"),
                (ge, ":opponent_agent_id", 0),
                (agent_is_alive, ":opponent_agent_id"),
                (agent_get_position, pos54, ":opponent_agent_id"),
                (position_move_y, pos54, 250),
                (set_fixed_point_multiplier, 100),
                (position_get_x, ":x_coor", pos54),
                (position_get_y, ":y_coor", pos54),
                (position_get_z, ":z_coor", pos54),
              ...
              (try_end),
              (player_set_slot, ":player_no", slot_player_revive_pos, 1),
